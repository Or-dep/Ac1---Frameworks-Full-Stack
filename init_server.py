...
@app.route('/main')
def main():
    print(f"Utilize a URL como base http://127.0.0.1:8085/main?nota1=8&nota2=6 para enviar os parametros de nota1 e nota2 para saber se a média dessas 2 notas o possibilita passar de ano.")
